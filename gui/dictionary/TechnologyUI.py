...
from gui.add_dictionary.AddRowPropPopup import AddRowPropPopup
from gui.add_dictionary.AddRowTechnologyPopup import AddRowTechnologyPopup
...
class TechnologyUI:
    ...
    def main_layout(self):
        ...
        button_layout.add_widget(AddRowButton(text='Добавить', ui=self, popup=AddRowTechnologyPopup,
                                              popup_title='Добавление записи "Технология"'))
        ...
        for prop in props:
            data_layout.add_widget(Label(text=str(prop.id), height=dp(30)))
            data_layout.add_widget(SelectableButton(text=str(prop.name), height=dp(30),
