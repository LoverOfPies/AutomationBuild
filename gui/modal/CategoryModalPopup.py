...
class CategoryModalPopup(Popup):
    ...
    def __init__(self, button_obj, change_flag, dict_class, owner_class, id_value, field, **kwargs):
        super(CategoryModalPopup, self).__init__(**kwargs)
        ...
        for category in categories:
            ...
            data_layout.add_widget(Label(text=str(category.name), size_hint_y=None, height=dp(30)))
            data_layout.add_widget(SelectRowButton(text='Выбрать', height=dp(30), popup=self,
                                                   name_row=category.name, button_obj=button_obj,
