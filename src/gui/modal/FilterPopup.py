...
class ModalPopup(Popup):
    ...
    def __init__(self, button_obj, ui_class, dict_class, owner_class, modal_title, **kwargs):
...
class FilterPopup(Button):
    ...
    def on_press(self):
        popup = self.modal_popup(self, self.ui, self.dict_class, self.owner_class, self.modal_title)
        popup.open()
