...
from src.gui.add_dictionary.material.AddRowMaterialGroupPopup import AddRowMaterialGroupPopup
...
class MaterialGroupUI:
    ...
    add_popup = AddRowMaterialGroupPopup
    ...
    def main_layout(self):
        ...
        for group in groups:
            ...
            data_layout.add_widget(SelectableModalButton(height=dp(30),
                                                         text=str(group.material_category.name),
